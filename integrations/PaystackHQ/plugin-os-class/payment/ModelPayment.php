<?php
    ...
    class ModelPayment extends DAO
    {
        ...
        public function install() {
            ...
            osc_set_preference('paystack_enabled', '0', 'payment', 'BOOLEAN');
            osc_set_preference('paystack_sandbox', 'sandbox', 'payment', 'STRING');
            osc_set_preference('paystack_tsk', '', 'payment', 'STRING');
            osc_set_preference('paystack_tpk', '', 'payment', 'STRING');
            osc_set_preference('paystack_lsk', '', 'payment', 'STRING');
            osc_set_preference('paystack_lpk', '', 'payment', 'STRING');
        ...
        public function uninstall()
        {
            ...
            osc_delete_preference('paystack_enabled', 'payment');
            osc_delete_preference('paystack_sandbox', 'payment');
            osc_delete_preference('paystack_tpk', 'payment');
            osc_delete_preference('paystack_tsk', 'payment');
            osc_delete_preference('paystack_lpk', 'payment');
            osc_delete_preference('paystack_lsk', 'payment');
