...
*/
    ...
    if(osc_get_preference('paystack_enabled', 'payment')==1) {
      require_once osc_plugins_path() . osc_plugin_folder(__FILE__) . 'payments/paystack/Paystack.php';
      osc_add_hook('ajax_paystack', array('Paystack', 'processPayment'));
    }
